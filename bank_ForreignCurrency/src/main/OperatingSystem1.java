...
public class OperatingSystem1 {
   ...
   public static void main(String[] args) {
      ...
      Trading1 trading1 = new Trading1();
      
//      boolean run = true;      // 프로그램 실행: true
      // ArrayList 함수 교수님 예시 ==============================================
//      listArea();    //main 함수에서 실행하는 코드
      
      String exData = trading1.checkTodayData();
      
      if (exData.equals("0")) {
         // 날짜 없음
         eVo = trading1.randomRateInfo();
         System.out.println("날짜 없음");
         System.out.println(eVo);
         trading1.insertExchangesRate(eVo.getBase_rate(), eVo.getPurchase_krw(), eVo.getSelling_krw());
         
      } else {
         // 날짜 있음
         eVo = trading1.clacExRate(exData);
...
//      if(exchangesInfo.exchangesInfo() == null) {
//         System.out.println("오늘 정보가 없다.");
//      };
